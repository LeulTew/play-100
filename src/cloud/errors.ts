export function onlineError(error: unknown): string {
  ...
  const messages: Record<string, string> = {
    ...
    'auth/popup-blocked': 'Your browser blocked the Google window. Try the button again, or choose Use email.',
    'auth/internal-error': 'The sign-in window could not initialize. Retry Google, or use email without changing your browser privacy settings.',
