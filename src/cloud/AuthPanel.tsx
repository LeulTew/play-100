...
export function AuthPanel({ busy, error, message, onGoogle, onEmail, onReset, onDevice }: {
  ...
  return (
    <div className="auth-panel">
      ...
      <p className="account-privacy">Your sign-in email is not public. Before online saving, you choose which library to use and consent to the creator seeing your account profile and ranking summary. Public sharing is a separate choice.</p>
