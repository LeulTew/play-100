...
const PAGE_TITLES: Record<AppPage, string> = { collection: 'Find your next game', library: 'My library', rankings: 'My rankings', discover: 'Discover more games' };
...
export default function App() {
  ...
  const library = useLibrary(canonicalRecords, collection.status === 'loading');
  const { page, filters, game: selectedSlug, updateFilters, openGame, closeGame, goToPage } = useUrlState();
  ...
  const privateLoading = page !== 'collection' && library.status === 'loading';
