...
export function Icon({ name, ...props }: SVGProps<SVGSVGElement> & { name: IconName }) {
  const paths: Record<IconName, React.ReactNode> = {
    ...
    shuffle: (
      <>
        <path d="M3 6h3l12 12h3M3 18h3L18 6h3m-4-4 4 4-4 4m0 4 4 4-4 4" />
      </>
    ),
    share: (
      <>
        <path d="M12 16V3m-4 4 4-4 4 4M5 11v10h14V11" />
      </>
    ),
    info: (
      <>
    ...
    stack: (
      <>
        ...
        <path d="M3 12l9 4 9-4M3 17l9 4 9-4" fill="none" />
      </>
    ),
    copy: (
      <>
    ...
    rank: (
      <>
        <path d="M4 19V11h5v8m0 0V5h6v14m0 0V9h5v10M3 19h18" />
      </>
    ),
    trash: (
      <>
