  ...
  return (
    <nav className="mobile-nav" aria-label="Mobile navigation">
      ...
      <a
        href={pageHref('games')}
        aria-current={
          ['games', 'library', 'rankings'].includes(page) && (onlineAvailable || gamesView !== 'ranking')
            ? 'page'
            : undefined
        }
      ...
      {onlineAvailable ? (
        ...
        <a
          href={pageHref('rankings')}
          aria-current={personalPage === 'rankings' ? 'page' : undefined}
          onClick={(event) => onNavigateLink(event, 'rankings')}
        >
