...
export function DialogHost({ page, game, catalog, loadingGame, canonicalError, missingGame, onCloseGame, menu, about, settings, offlineSettings, manualShare }: DialogHostProps) {
