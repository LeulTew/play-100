...
export function RouteFallback(props: RouteFallbackProps) {
  ...
  const status = <p className="section-help" role="status">{props.kind === 'private-library' ? 'Opening your guest or account library before allowing edits.' : `Loading ${title}…`}</p>;
