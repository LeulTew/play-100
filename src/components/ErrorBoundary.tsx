    ...
    if (this.state.failed) {
      return (
        <main className="app-error">
          ...
          <button className="button button-dark" onClick={() => window.location.reload()}>Reload the collection</button>
          <a href="/downloads/Play-100-Collection.xlsx" download>Or download the workbook</a>
        </main>
      );
    }
