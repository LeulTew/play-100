...
export default function LibraryPage({ state, filters, busy, animate, onFilters, onAction, onOpen, onDiscover, onBrowse, embedded = false, workspaceView, completedOnly = false, progressFilter, onPin, onUnpin, pinnedIds, renderDragHandle }: LibraryPageProps) {
  ...
  useEffect(() => { setSelected(new Set()); }, [tab, query, progressView]);
