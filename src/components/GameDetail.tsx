      ...
      <div className="detail-top" ref={topRef}>
        ...
        <p className="device-note">
          {mode.scope === 'guest'
            ...
            : 'Account progress. See Account for sync status.'}
        </p>
        {onRank && (
      ...
      <section className="detail-section critic-section">
        <div className="section-title-line">
          ...
          <div className="average">
            <strong>{formatAverage(game.criticAverage)}</strong>
            {game.criticAverage !== null && <span> / 100</span>}
          </div>
        </div>
            ...
            <div key={key}>
              ...
              <dd>
                {game.critics[key] === null ? (
                  <span className="score-missing">Unavailable</span>
                ) : (
                  <>
                    <strong>{game.critics[key]}</strong>
                    <span> / {scale}</span>
                  </>
                )}
              </dd>
        ...
        <details className="methodology-details">
          ...
          <p>
            The displayed average normalizes every available entered score to 100, then averages those columns. General
            and PC Metacritic each count when both are present. Missing scores are excluded. This is not an official
          ...
          <p>
            Your rating belongs to the active library, never prefilled from {author.shortName}'s. Public sharing
            requires a separate preview and publish action.
          </p>
        </details>
      </section>
