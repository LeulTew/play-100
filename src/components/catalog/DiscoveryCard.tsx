      ...
      <div className="discovery-card-body">
        ...
        <details className="discovery-card-details">
          ...
          <div className="discovery-card-secondary">
            ...
            <button className="button button-outline" disabled={busy} aria-label={`Play later: ${record.title}`} aria-pressed={Boolean(progress?.later)} onClick={() => { void onAction({ type: 'toggle-progress', record: actionRecord, key: 'later' }); }}><Icon name="bookmark" width="16" height="16" fill={progress?.later ? 'currentColor' : 'none'} />Play later</button>
