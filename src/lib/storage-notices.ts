export const STORAGE_DENIED_MESSAGE =
  'Device storage is blocked. Allow this site to use device storage and try again. Your saved data has not been overwritten or cleared.';
