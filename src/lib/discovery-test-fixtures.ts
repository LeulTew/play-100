...
export const discoveryFixture: DiscoveryItem = {
  record: {
    ...
    genre: 'RPG',
    sourceUrl: 'https://www.wikidata.org/wiki/Q15408545',
    collectionRank: null,
  },
  ...
  provenance: {
    ...
    artworkMissingReason: 'No verified reusable image in this test fixture.',
  },
};
...
export const catalogFixture: DiscoveryCatalog = {
  schemaVersion: 1,
    ...
    ratings: [
      {
        ...
        platforms: ['PC'],
        method: 'Critic average',
        count: 32,
        asOf: '2024-04-20',
        referenceDate: '2024-04-21',
        retrievedAt: '2026-09-22T12:00:00.000Z',
        sourceUrl: 'https://www.wikidata.org/wiki/Q15408545#P444',
        referenceUrl: 'https://example.com/reviews/game',
      },
    ],
    artwork: null,
    sources: [
      {
        ...
        status: 'ready',
        code: null,
        message: 'Review scores supplied by Wikidata.',
        retryAfter: 0,
      },
      {
        source: 'steam',
        status: 'unavailable',
        code: 'ambiguous',
        message: 'More than one Steam app is listed; no rating was chosen.',
        retryAfter: 0,
      },
      {
        source: 'commons',
        status: 'unavailable',
        code: 'missing',
        message: 'No verified reusable image was supplied.',
        retryAfter: 0,
      },
    ],
  };
